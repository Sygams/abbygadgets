...
<head>
   ...
   <title>Abby & Elena Gadgets.Com</title>
...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            <span>With Free Accessories</span>
...
<section class="category">
   ...
   <a href="category.php?category=smartphone" class="swiper-slide slide">
      <img src="images/smartphone icon.png" alt="">
      <h3>Smartphones</h3>
   </a>

   <a href="category.php?category=tablet" class="swiper-slide slide">
      <img src="images/tablet icon.webp" alt="">
      <h3>Tablet</h3>
   </a>
   ...
   <a href="category.php?category=keyboard" class="swiper-slide slide">
      <img src="images/keyboard icon.jpg" alt="">
      <h3>Keyboard</h3>
   </a>
